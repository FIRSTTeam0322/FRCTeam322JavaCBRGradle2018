...
public class RobotMap {
    ...
    public static WPI_TalonSRX midArmwristMotor;
    ...
    public static void init() {
        ...
        lowerArmleftLowerArmMotor.setInverted(false);
        lowerArmrightLowerArmMotor = new WPI_TalonSRX(6);
        lowerArmrightLowerArmMotor.setInverted(true);
        ...
        midArmwristMotor = new WPI_TalonSRX(10);
        midArmwristMotor.setName("midArm", "wristMotor");
