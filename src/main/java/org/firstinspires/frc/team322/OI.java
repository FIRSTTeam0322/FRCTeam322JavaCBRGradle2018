...
public class OI {
    ...
    public JoystickButton pullCrateButton, pushCrateButton;
    public JoystickButton climbArmExtensionButton, climbArmRetractionButton;
    public JoystickButton climbArmWinchExtendButton, climbArmWinchRetractButton;
    ...
    public OI() {
        ...
        SmartDashboard.putData("MidArmControl", new MidArmControl());
